...
## Vincoli
- Non generare requisiti che contraddicano le regole di comportamento dell'assistente (mai consigli fiscali definitivi, max 3 tentativi per voce, tono sempre semplice)
...
- Non modificare file al di fuori di `agents/requirements/` per il salvataggio dei requisiti
